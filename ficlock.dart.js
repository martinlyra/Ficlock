...
z=H.d(this.b)+" "+H.d(this.c)+", "+H.d(this.a)+" T"
y=this.a
if(typeof y!=="number")return y.S()
return z+H.d(y/4)+"-"+H.d(this.e)}},
W:{
"^":"a;Q,a,b,c",
X:function(a){return H.d(this.b)+" "+H.d(this.Q)+" "+H.d(this.c)+"NE"}},
M:{
"^":"a;Q,a,b,c,d,e",
X:function(a){return"ID."+H.d(this.Q)+"."+H.d(this.a)+"."+H.d(this.b)}},
BW:{
"^":"a;Q,a,b,c,d,e,f",
X:function(a){return J.Gw(this.Q,8)+"."+J.Gw(this.a,8)+"."+J.Gw(this.b,8)}},
O:{
"^":"a;Q,a,b",
X:function(a){return H.d(this.Q)+" "+H.d(this.a)}}}],["","",,H,{
"^":"",
FK:{
"^":"a;Q"}}],["","",,J,{
"^":"",
...
Ap:function(a){return this.Z(Math.floor(a))},
...
Y:function(a,b){return(a|0)===a?a/b|0:this.Z(a/b)},
...
return z.$1(new H.W0(v,null))}}if(a instanceof TypeError){u=$.N1()
t=$.OI()
s=$.PH()
r=$.D1()
q=$.rx()
...
dp:function(a,b){var z=C.CD.Y(a.Q,1000)
return H.VJ(z<0?0:z,b)},
PJ:function(a){var z=$.X3
$.X3=a
return z},
L2:function(a,b,c,d,e){var z,y,x
z=new P.OM(new P.pK(d,e),C.L,null)
y=$.S6
if(y==null){P.IA(z)
$.mg=$.k8}else{x=$.mg
if(x==null){z.b=y
...
Gr:function(a){if($.X3===C.L)return a.$0()
return P.T8(null,null,this,a)},
FI:function(a,b){if($.X3===C.L)return a.$1(b)
...
Ou:[function(a,b){return J.mG(a,b)},"$2","iv",4,0,11],
T9:[function(a){return J.v1(a)},"$1","rm",2,0,12],
...
ad:[function(a,b){return a==null?b==null:a===b},"$2","N3",4,0,13],
...
static:{Gg:function(a,b,c,d,e,f,g){return new P.iP(H.fI(H.Nq(a,b,c,d,e,f,g,!1)),!1)},Wu:function(a,b){var z=new P.iP(a,b)
z.RM(a,b)
...
static:{T:function(a,b,c,d,e,f){return new P.a6(864e8*a+36e8*b+6e7*e+1e6*f+1000*d+c)}}},
P7:{
"^":"r:8;",
...
UK:{
"^":"a;Q,a,b,c,d,e,f,r",
X:function(a){return""+this.f+"-"+this.e+"-"+this.d},
L4:function(){var z=new P.iP(Date.now(),!1)
this.f=H.tJ(z)
this.e=H.NS(z)
this.d=H.jA(z)
this.c=H.KL(z)
...
this.a=H.Jd(z)
this.Q=H.o1(z)
if(Z.oe(this.f))this.r=!0},
static:{rK:function(){var z=new Z.UK(null,null,null,null,null,null,null,null)
z.L4()
return z},oe:function(a){if(Z.o6(a/4))return!1
else if(Z.o6(a/100))return!0
else if(Z.o6(a/400))return!1
else return!0},o6:function(a){var z
if(typeof a==="number"&&Math.floor(a)===a){C.jn.V(a,1)
z=!0}else z=!1
return!z||!1}}}}],["","",,X,{
"^":"",
N:function(){var z=P.T(735613.5,0,0,0,0,0)
return C.CD.Y(P.T(1024557.25,0,0,0,0,0).Q,1000)/C.CD.Y(z.Q,1000)},
Q:[function(){var z,y
for(z=1;z<=12;++z){y=""+z+" "+C.CD.Z(Math.floor(Math.ceil(z/2)))
H.U(y)}P.P(X.N())
X.V()},"$0","ao",0,0,1],
V:function(){$.R=new X.W(null,null,null,null)
$.X=new X.M(null,null,null,C.CD.Y(P.T(0,10080,0,0,0,0).Q,1000),C.CD.Y(P.T(0,840,0,0,0,0).Q,1000),C.CD.Y(P.T(0,28,0,0,0,0).Q,1000))
$.mF=new X.O(null,null,2790)
$.Q6=new X.WD(null,null,null,null,null,null,null)
$.pq=new X.BW(null,null,null,null,null,null,null)
$.Z=P.S(C.jm,new X.Y())},
Y:{
"^":"r:9;",
...
n=y.b
m=y.a
l=P.Wu(((x-1)*w*v*u*t*s+r*q*v*u*t*s+p*v*u*t*s+o*u*t*s+n*t*s+m*s+m)*X.N(),!1)
l=P.Wu(l.Q-C.CD.Y($.MY().Q,1000),l.a)
m=$.R
m.toString
m.a=C.CD.Z(Math.floor(Math.ceil(H.NS(l)/2)))
s=H.tJ(l)
if(s<2797){m.Q=2797-s
m.c="B"}else{m.Q=s-2797
m.c=""}switch(m.a){case 1:m.b="Ianuaria"
break
case 2:m.b="Martex"
break
case 3:m.b="Iunius"
...
v=x.c
j=k/v+219490
i=C.CD.Z(Math.floor(C.ON.V(j,1000)))
h=C.CD.Z(Math.floor(j/1000))
x.Q=""+i+"."+h
k=C.CD.V(k,v)
if(k<0)k=v+k
v=x.d
x.a=C.CD.Z(Math.floor(k/v))+1
x.b=C.CD.Z(Math.floor(C.CD.V(k,v)/x.e))+1
x=$.mF
x.toString
g=H.tJ(l)
v=x.b
if(g<v){x.Q=-(v-g)
x.a="BQF"}else{x.Q=g-v
x.a="AQF"}x=$.Q6
x.toString
v=H.tJ(l)
v=H.fI(H.Nq(v,1,1,0,0,0,0,!1))
u=H.tJ(l)
x.f=(w-v)/((H.fI(H.Nq(u+4,1,1,0,0,0,0,!1))-v)/4)
v=H.tJ(l)
u=C.jn.V(H.tJ(l),4)
x.b=H.jA(l)
x.c=H.NS(l)
...
t=(v-u-2800)*4+1892+C.CD.Z(Math.floor(t*4))
x.a=t
switch(x.c){case 1:case 2:case 3:x.e="A"
break
case 4:case 5:case 6:x.e="B"
x.a=t+1
break
case 7:case 8:case 9:x.e="C"
x.a=t+2
break
case 10:case 11:case 12:x.e="D"
x.a=t+3
break
default:x.e=""
break}x=$.pq
...
f=w-v
x.Q=C.CD.Z(Math.abs(f/66706210816))
f=C.CD.V(f,66706210816)
x.e=C.CD.Z(Math.abs(C.ON.V(f/497,64)))
x.d=C.CD.Z(Math.abs(C.ON.V(f/31808,64)))
x.c=C.CD.Z(Math.abs(C.ON.V(f/2035712,64)))
x.b=C.CD.Z(Math.abs(C.ON.V(f/130285568,64)))
x.a=C.CD.Z(Math.abs(C.ON.V(f/8338276352,8)))
document.querySelector("#cyrannian").querySelector(".time").textContent=J.Lz($.R)
document.querySelector("#draconid").querySelector(".time").textContent=J.Lz($.X)
document.querySelector("#rambo").querySelector(".time").textContent=J.Lz($.mF)
document.querySelector("#bunsen").querySelector(".time").textContent=J.Lz($.Q6)
document.querySelector("#farengeto").querySelector(".time").textContent=J.Lz($.pq)
document.querySelector("#fictionverse").querySelector(".time").textContent=""+H.tJ(l)+"-"+H.NS(l)+"-"+H.jA(l)
e=H.KL(z)<10?"0"+C.jn.X(H.KL(z)):C.jn.X(H.KL(z))
d=H.ch(z)<10?"0"+C.jn.X(H.ch(z)):C.jn.X(H.ch(z))
c=H.Jd(z)<10?"0"+C.jn.X(H.Jd(z)):C.jn.X(H.Jd(z))
document.querySelector("#real-time").textContent=e+":"+d+":"+c
x=$.Wz
if(x!=null)if(x instanceof P.iP){x.toString
if(H.tJ(x)===H.tJ(z)){x=$.Wz
x.toString
if(H.NS(x)===H.NS(z)){x=$.Wz
x.toString
x=H.jA(x)!==H.jA(z)}else x=!0}else x=!0}else x=!0
else x=!0
if(!(!x||!1)){b=H.jA(z)<10?"0"+C.jn.X(H.jA(z)):H.jA(z)
a=H.NS(z)<10?"0"+C.jn.X(H.NS(z)):H.NS(z)
g=H.tJ(z)
$.Wz=z
document.querySelector("#real-date").textContent=""+g+"-"+H.d(a)+"-"+H.d(b)}return}}},1]]
setupProgram(dart,0)
...
var w=a[y+1]
var v=a[y+2]
I.$lazy(x,w,v)}})(["xg","xb",function(){return P.Gg(2783,5,16,0,0,0,0)},"UI","rR",function(){return $.xb().Q},"Kb","Rs",function(){return H.yl()},"rS","p6",function(){return new P.kM(null)},"lm","N1",function(){return H.cM(H.S7({toString:function(){return"$receiver$"}}))},"k1","OI",function(){return H.cM(H.S7({$method$:null,toString:function(){return"$receiver$"}}))},"Re","PH",function(){return H.cM(H.S7(null))},"fN","D1",function(){return H.cM(function(){var $argumentsExpr$='$arguments$'
...
try{(void 0).$method$($argumentsExpr$)}catch(z){return z.message}}())},"BX","zO",function(){return H.cM(H.Mj(null))},"tt","Bi",function(){return H.cM(function(){try{null.$method$}catch(z){return z.message}}())},"dt","eA",function(){return H.cM(H.Mj(void 0))},"A7","ko",function(){return H.cM(function(){try{(void 0).$method$}catch(z){return z.message}}())},"lI","ej",function(){return P.Oj()},"d2","hi",function(){return[]},"ta","MY",function(){return P.T(C.CD.Ap(C.ON.UD(719542.5)),0,0,0,0,0)}])
I=I.$finishIsolateConstructor(I)
$=new I()
init.metadata=[]
init.types=[{func:1},{func:1,void:true},{func:1,args:[,]},{func:1,args:[,P.I]},{func:1,args:[P.I]},{func:1,args:[{func:1,void:true}]},{func:1,args:[,,]},{func:1,args:[P.wv,,]},{func:1,ret:P.I,args:[P.KN]},{func:1,args:[P.kW]},{func:1,void:true,args:[{func:1,void:true}]},{func:1,ret:P.a2,args:[,,]},{func:1,ret:P.KN,args:[,]},{func:1,ret:P.a2,args:[P.a,P.a]},{func:1,ret:P.KN,args:[P.a]}]
...
if(typeof dartMainRunner==="function")dartMainRunner(function(b){H.Rq(X.ao(),b)},[])
else (function(b){H.Rq(X.ao(),b)})([])})})()